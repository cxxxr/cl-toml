...
2, # OK
  ...
  (subtest "table"
    (let ((toplevel (esrap:parse 'toml::toplevel "[table]
key = \"value\"
bare_key = \"value\"
bare-key = \"value\"
...
")))
    ...
    (let ((table (esrap:parse 'toml::toplevel "[dog.\"tater.man\"]
type = \"pug\"
")))
      (is "pug" (gethash "type" (gethash "tater.man" (gethash "dog" table))) :test #'equal))
    (let ((table (esrap:parse 'toml::toplevel "[a.b]
c = 1
...
")))
  ...
  (subtest "inline-table"
    (let ((table (esrap:parse 'toml::toplevel "name = { first = \"Tom\", last = \"Preston-Werner\" }
point = { x = 1, y = 2 }
")))
  ...
  (subtest "array-table"
    (let ((table (esrap:parse 'toml::toplevel "[[products]]
name = \"Hammer\"
sku = 738594937
...
")))
    ...
    (let ((table (esrap:parse 'toml::toplevel "
[[fruit]]
name = \"apple\"
